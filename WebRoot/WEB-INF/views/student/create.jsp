					...
					<div class="panel-body">
						<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/student/save" method="post">
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="text" id="studentNumber" name="student.studentNumber" placeholder="学号" class="form-control" required="required" />
								</div>
							</div>
							<div class="form-group">
								<label for="studentName" class="col-md-2 control-label">姓名</label>
								<div class="col-md-10">
									<input type="text" id="student.studentName" name="student.studentName" placeholder="姓名" class="form-control" required="required" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<div class='input-group date' id='birthday'>
										<input type='text' class="form-control" name="student.birthday" required="required"/>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="email" id="email" name="student.email" placeholder="邮箱" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label for="mobile" class="col-md-2 control-label">联系方式</label>
								<div class="col-md-10">
									<input type="text" id="mobile" name="student.mobile" placeholder="联系方式" class="form-control" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="text" id="address" name="student.address" placeholder="详细地址" class="form-control" />
								</div>
							</div>
							<div class="form-group">
